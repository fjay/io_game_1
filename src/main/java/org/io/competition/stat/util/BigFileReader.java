...
public class BigFileReader {
    ...
    private BigFileReader(File file, LineHandler handle, String charset, int bufferSize, int threadSize) {
    ...
    public void start() {
        ...
        for (StartEndPair pair : startEndPairs) {
            ...
            futures.add(this.executorService.submit(new SliceReaderTask(pair)));
        }
    }
